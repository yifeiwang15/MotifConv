...
class QM9(InMemoryDataset):
    ...
    def process(self):
        ...
        # The excluded list of molecules is from the Supporting Information of      
        # https://pubs.acs.org/doi/10.1021/acs.jctc.7b00577
        
        with open("excludedMolecules_MG.txt", 'r') as f:
            skip = [int(x.split(":")[-1])-1 for x in f.read().split('\n')[:-1]]
